...
**[Bookstore-App]** is a Single Page Application website that lets users to display a list of books, add a book and remove a selected book.
...
```sh
  git https://github.com/Mikey1-nuel/Bookstore.git
  cd Bookstore
```
...
Feel free to check the [issue page](https://github.com/Mikey1-nuel/Bookstore/issues).
